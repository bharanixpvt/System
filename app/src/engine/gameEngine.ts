...
export function createDefaultShopItems(): import('@/types').ShopItem[] {
  return [
    ...
    { id: 'boss-beacon', type: 'utility', name: 'Boss Beacon', description: 'Calls a boss dungeon when you are ready.', effect: 'Activates from Inventory', cost: 120, preview: 'boss', purchased: false },
