...
export function generateDailyQuests(): Quest[] {
  ...
  const dailyQuestTemplates = [
    ...
    { name: 'Combat Practice', description: 'Complete 3 rounds of shadow boxing', category: 'combat' as const, xpReward: 35 },
  ];
  
  return dailyQuestTemplates.map((template, index) => ({
...
export function generateSideQuests(): Quest[] {
...
export function createDefaultDungeons(): import('@/types').Dungeon[] {
  return [
    ...
    {
      id: 'dungeon-boss-1',
      name: 'Monthly Boss Dungeon',
      type: 'boss',
      description: 'The ultimate monthly test. Max effort across all domains.',
      difficulty: 5,
      color: '#8B5CF6',
      estimatedMinutes: 45,
      xpReward: 800,
      ...
      requirements: 'Complete 5 Dungeons to unlock',
    },
  ];
}
...
export function createDefaultShopItems(): import('@/types').ShopItem[] {
  return [
    { id: 'theme-dark-cyan', type: 'theme', name: 'Dark Cyan', description: 'Deep cyan accent theme', cost: 500, preview: '#4FD8FF', purchased: false },
    { id: 'theme-shadow-purple', type: 'theme', name: 'Shadow Purple', description: 'Mystical purple accent', cost: 750, preview: '#8B5CF6', purchased: false },
    { id: 'theme-monarch-gold', type: 'theme', name: 'Monarch Gold', description: 'Golden luxury accent', cost: 1000, preview: '#EAB308', purchased: false },
    { id: 'theme-crimson', type: 'theme', name: 'Crimson Edge', description: 'Aggressive red accent', cost: 750, preview: '#EF4444', purchased: false },
    { id: 'anim-lvl-up-1', type: 'animation', name: 'Cyan Burst', description: 'Level-up cyan particle burst', cost: 300, preview: 'burst', purchased: false },
    { id: 'anim-lvl-up-2', type: 'animation', name: 'Monarch Rise', description: 'Royal level-up animation', cost: 600, preview: 'royal', purchased: false },
    { id: 'custom-border-1', type: 'customization', name: 'Neon Border', description: 'Glowing neon card borders', cost: 400, preview: 'neon', purchased: false },
    { id: 'custom-border-2', type: 'customization', name: 'Crystal Frame', description: 'Crystal-clear glass frames', cost: 500, preview: 'crystal', purchased: false },
    { id: 'widget-xp', type: 'widget', name: 'XP Widget', description: 'Floating XP counter widget', cost: 200, preview: 'xp', purchased: false },
    { id: 'widget-stats', type: 'widget', name: 'Stats Widget', description: 'Mini stat display widget', cost: 200, preview: 'stats', purchased: false },
  ];
}
