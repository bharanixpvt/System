...
import {
  ShoppingBag, Coins, Palette, Sparkles, Shirt, LayoutGrid, Check
} from 'lucide-react';
...
export function ShopScreen() {
  ...
  const categories = ['theme', 'animation', 'customization', 'widget'] as ShopItemCategory[];

  const isPurchased = (itemId: string) => inventory.some(i => i.id === itemId);
  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      <p className="text-sm text-white/40 mb-4">Spend coins on cosmetic upgrades</p>
